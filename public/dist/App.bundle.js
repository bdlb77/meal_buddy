...
var eventSwipe = function eventSwipe() {
	var arrowRight = document.querySelector('.fas.fa-angle-double-right');
	var arrowLeft = document.querySelector('.fas.fa-angle-double-left');
	var cards = document.querySelectorAll('.event__card');
	var parentNode = document.querySelector('.event__cards');
...
function makeMap(mapDiv) {
	...
	var _JSON$parse = JSON.parse(mapDiv.dataset.coords),
...
var _reviewFormAnimate = __webpack_require__(13);

var _reviewFormAnimate2 = _interopRequireDefault(_reviewFormAnimate);

var _eventsSwipe = __webpack_require__(10);

var _eventsSwipe2 = _interopRequireDefault(_eventsSwipe);
...
if (arrowRight && arrowLeft) (0, _eventsSwipe2.default)();
